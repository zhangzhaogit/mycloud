...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        ...
        final String DB_URL = "jdbc:mariadb://192.168.1.152:3306/icapweb?useUnicode=true&useSSL=false&characterEncoding=utf8";
        final String DB_DRIVER = "org.mariadb.jdbc.Driver";
        final String DB_USERNAME = "root";
        final String DB_PASSWORD = "123456";
        final String PACKAGE_DIR = "com.zz.module";
        //多表可,隔开
