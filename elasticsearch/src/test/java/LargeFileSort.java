...
public class LargeFileSort {
    ...
    private final static String ROOT_FILE_PATH = "C:\\Users\\zhangzhao\\Desktop\\个人\\file";
    // 测试文件
    private static String[] genFiles = new String[3];
    // 切分大文件的512k, 默认为 512k
    ...
    public static void generateTestFiles() {
        // 启用十个线程生成测试文件
        ExecutorService executorService = Executors.newFixedThreadPool(genFiles.length);
        doneSignal = new CountDownLatch(genFiles.length);
